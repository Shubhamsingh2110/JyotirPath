          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left order-2 lg:order-1">
            <div className="space-y-4 sm:space-y-6">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-normal text-gray-900 leading-tight font-serif">
                The Ancient Art<br className="hidden sm:block" />
                <span className="block sm:inline">of Palm Reading</span>
              </h1>

              <div className="space-y-3 sm:space-y-4 text-gray-600 text-base sm:text-lg max-w-lg mx-auto lg:mx-0">
                <p>Palmistry, also known as chiromancy, is an ancient divination practice that has been used for thousands of years to understand personality traits, predict future events, and gain insights into an individual's life path through the study of palm lines, mounts, and hand characteristics.</p>
                <p>Your palms contain a detailed map of your life's journey. Every line, mount, and finger formation tells a unique story about your personality, relationships, career prospects, health patterns, and spiritual development.</p>
              </div>
            </div>
